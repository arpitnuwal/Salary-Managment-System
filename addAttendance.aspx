<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="addAttendance.aspx.cs" Inherits="addAttendance" %>
            ...
            <div class="split">
                ...
                <div class="card" style="animation-delay:0s">
                    <div class="card-header">
                        ...
                        <div>
                            <div class="card-header-title">Attendance Entry</div>
...
<asp:DropDownList ID="ddlYear" runat="server" CssClass="form-control"></asp:DropDownList><br />
                            <label for="txtEmpCode">Attendance Sheet Upload      (format .xlsx)</label>
